...
void setup() {
  ...
  */
  ...
  ColorMenu.init(MENU_TEXT, MENU_BACKGROUND, MENU_HIGHLIGHTTEXT, MENU_HIGHLIGHT, MENU_SELECTTEXT, MENU_SELECT,
                 DATA_COLUMN, 30, 5, "Color Menu", FONT_ITEM, FONT_TITLE);
  ...
  ColorOption4 = ColorMenu.addNI("Selector Bar", 10, 0, sizeof(C_NAMES) / sizeof(C_NAMES[0]), 1, 0, C_NAMES);
  ColorOption5 = ColorMenu.addNI("Selector Border", 44, 0, sizeof(C_NAMES) / sizeof(C_NAMES[0]), 1, 0, C_NAMES);
  ...
  ColorOption8 = ColorMenu.addNI("Edit Border", 38, 0, sizeof(C_NAMES) / sizeof(C_NAMES[0]), 1, 0, C_NAMES);
