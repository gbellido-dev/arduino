...
#define DEFAULT_IP_ADDRESS "172.17.17.80"
...
void setup(){
  ...
  staticIP.fromString(DEFAULT_IP_ADDRESS);
  ...
  server.on("/", HTTP_GET, [](AsyncWebServerRequest *request){
    String newIndex = String(index_html);
    newIndex.replace("%TEMPERATUREC%", temperatureC);
    newIndex.replace("%TEMPERATUREF%", temperatureF);
    request->send(200, "text/html", newIndex);
  });
