...
const char ssid[] = "NodeMCU-ESP8266-X";    //Definimos la SSDI de nuestro servidor WiFi -nombre de red- 
...
void setup() {
  ...
  pinMode(LED_PIN, OUTPUT);                //Inicializamos el GPIO2 como salida
  digitalWrite(LED_PIN, LOW);              //Dejamos inicialmente el GPIO2 apagado
